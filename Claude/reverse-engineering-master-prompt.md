...
- This is a **rebuild guide**, so bias toward *actionable* documentation over prose description.
...
- **Business Logic Documentation**: the *domain rules* — validation rules, pricing/permission/state-transition rules, anything that encodes "how the business actually works," separated clearly from technical plumbing
